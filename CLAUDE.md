...
| `review_mode` | init, local/session | init, scope, comments, overview, files, preview, ui/comment_browser, local/session, local/tracker |
| `local_session` | local/session | comments, comments/local_sync, files, scope, preview, local/session |
